...
\begin{figure}[t!]
\centering
\includegraphics[width=1\textwidth]{4.matching/images/method}
...
\begin{figure}[t!]
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.4in]{4.matching/images/one}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.4in]{4.matching/images/two}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[height=1.4in]{4.matching/images/three}
...
\begin{figure}[t!]
    ...
    \begin{subfigure}[t]{0.52\textwidth}
        \centering
        \includegraphics[height=1.7in]{4.matching/images/synthetic}
    ...
    \begin{subfigure}[t]{0.52\textwidth}
        \centering
        \includegraphics[height=1.7in]{4.matching/images/real}
